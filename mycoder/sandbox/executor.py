...
# (volume kept; restarted transparently on the next call). Override with
# MYCODER_SANDBOX_IDLE_TIMEOUT; 0 disables reaping.
...
class SandboxManager:
    ...
    def __init__(
        ...
        *,
        ...
        self._idle_timeout = (
            _idle_timeout_from_env() if idle_timeout is None else max(0.0, float(idle_timeout))
        )
